...
(function ($) {
    ...
    if ($("#googlemap").length > 0) {
        ...
        var myOptions = {
            ...
            zoom: 15,
            center: new google.maps.LatLng(45.739768, 4.8173446), //change the coordinates
        ...
        var marker = new google.maps.Marker({
            ...
            map: map,
            position: new google.maps.LatLng(45.739768, 4.8173446)  //change the coordinates

        });

        var infowindow = new google.maps.InfoWindow({

            content: "<div style='color:#222'><b>École Le-101</b></div>"  //change your address
